  ...
  render() {
    return (
      <ListGroup className={[s.listGroup, "thin-scroll"].join(" ")}>
        ...
        <ListGroupItem className={s.listGroupItem}>
          <span className={[s.notificationIcon, "thumb-sm"].join(" ")}>{/* <img className="rounded-circle" src={a6} alt="..." /> */}</span>
          <p className="m-0 overflow-hidden">
            {/* eslint-disable */}
        ...
        <ListGroupItem className={s.listGroupItem}>
          <span className={[s.notificationIcon, "thumb-sm"].join(" ")}>{/* <img className="rounded-circle" src={a3} alt="..." /> */}</span>
          <p className="m-0 overflow-hidden">
        ...
        <ListGroupItem className={s.listGroupItem}>
          <span className={[s.notificationIcon, "thumb-sm"].join(" ")}>{/* <img className="rounded-circle" src={a5} alt="..." /> */}</span>
          <p className="m-0 overflow-hidden">
            {/* eslint-disable */}
        ...
        <ListGroupItem className={s.listGroupItem}>
          ...
          <p className="m-0 overflow-hidden">
            {/* eslint-disable */}
            Instructions for changing your Envato Account password. Please check your account <a href="#">security page</a>.{/* eslint-enable */}
            <time className="help-block m-0">12:18 AM</time>
          </p>
        </ListGroupItem>
        <ListGroupItem className={s.listGroupItem}>
