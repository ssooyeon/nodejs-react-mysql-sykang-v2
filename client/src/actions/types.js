...
export const RETRIEVE_FOLDER_WITH_USERS = "RETRIEVE_FOLDER_WITH_USERS";
export const RETRIEVE_FOLDER = "RETRIEVE_FOLDER";
export const UPDATE_FOLDER = "UPDATE_FOLDER";
export const UPDATE_FOLDER_WITH_USERS = "UPDATE_FOLDER_WITH_USERS";
...
export const RETRIEVE_TASKS_BY_USER = "RETRIEVE_TASKS_BY_USER";
...
export const RETRIEVE_TODAY_SCHEDULES = "RETRIEVE_TODAY_SCHEDULES";
